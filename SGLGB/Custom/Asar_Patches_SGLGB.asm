; Note: Put your custom routine/data macros, references to them, and defines in this file from within the SGLGB_InsertIntegratedPatches and SGLGB_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro SGLGB_InsertIntegratedPatches()
...
macro SGLGB_ApplyPatchesPostAssembly()
